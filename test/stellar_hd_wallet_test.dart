...
void main(){
  test('get account id from mnemonic', () {
    ...
    expect(wallet.getSecretSeed(), "SBGWSG6BTNCKCOB3DIFBGCVMUPQFYPA2G4O34RMTB343OYPXU5DJDVMN");
    expect(wallet.getAccountId(index: 1), "GBAW5XGWORWVFE2XTJYDTLDHXTY2Q2MO73HYCGB3XMFMQ562Q2W2GJQX");
    expect(wallet.getSecretSeed(index: 1), "SCEPFFWGAG5P2VX5DHIYK3XEMZYLTYWIPWYEKXFHSK25RVMIUNJ7CTIS");
  });
}